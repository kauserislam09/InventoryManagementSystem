...
namespace InventoryManagementSystem {
    ...
    public partial class InventoryDBDataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, decimal Price, int Quantity) {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ([Pro" +
                "ductName] = @Original_ProductName) AND ([Price] = @Original_Price) AND ([Quantit" +
                "y] = @Original_Quantity))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([ProductName], [Price], [Quantity]) VALUES (@Produc" +
                "tName, @Price, @Quantity);\r\nSELECT ProductId, ProductName, Price, Quantity FROM " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductName] = @ProductName, [Price] = @Price, [Quantity] = @Quantity WHERE (([ProductId] = @Original_ProductId) AND ([ProductName] = @Original_ProductName) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity));
SELECT ProductId, ProductName, Price, Quantity FROM Products WHERE (ProductId = @ProductId)";
        ...
        public virtual int Fill(InventoryDBDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual InventoryDBDataSet2.ProductsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InventoryDBDataSet2.ProductsDataTable dataTable = new InventoryDBDataSet2.ProductsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventoryDBDataSet2.ProductsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductName, decimal Original_Price, int Original_Quantity) {
        ...
        public virtual int Insert(string ProductName, decimal Price, int Quantity) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, decimal Price, int Quantity, int Original_ProductId, string Original_ProductName, decimal Original_Price, int Original_Quantity, int ProductId) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, decimal Price, int Quantity, int Original_ProductId, string Original_ProductName, decimal Original_Price, int Original_Quantity) {
            return this.Update(ProductName, Price, Quantity, Original_ProductId, Original_ProductName, Original_Price, Original_Quantity, Original_ProductId);
        }
    }
