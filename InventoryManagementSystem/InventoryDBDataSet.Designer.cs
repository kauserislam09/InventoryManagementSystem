...
namespace InventoryManagementSystem {
    ...
    public partial class InventoryDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerName, string Address, string Phone) {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([CustomerId] = @Original_CustomerId) AND ([" +
                "CustomerName] = @Original_CustomerName) AND ([Address] = @Original_Address) AND " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([CustomerName], [Address], [Phone]) VALUES (@Custo" +
                "merName, @Address, @Phone);\r\nSELECT CustomerId, CustomerName, Address, Phone FRO" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerName] = @CustomerName, [Address] = @Address, [Phone] = @Phone WHERE (([CustomerId] = @Original_CustomerId) AND ([CustomerName] = @Original_CustomerName) AND ([Address] = @Original_Address) AND ([Phone] = @Original_Phone));
SELECT CustomerId, CustomerName, Address, Phone FROM Customers WHERE (CustomerId = @CustomerId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerId, CustomerName, Address, Phone FROM dbo.Customers";
        ...
        public virtual int Fill(InventoryDBDataSet.CustomersDataTable dataTable) {
        ...
        public virtual InventoryDBDataSet.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InventoryDBDataSet.CustomersDataTable dataTable = new InventoryDBDataSet.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventoryDBDataSet.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerId, string Original_CustomerName, string Original_Address, string Original_Phone) {
        ...
        public virtual int Insert(string CustomerName, string Address, string Phone) {
        ...
        public virtual int Update(string CustomerName, string Address, string Phone, int Original_CustomerId, string Original_CustomerName, string Original_Address, string Original_Phone, int CustomerId) {
            if ((CustomerName == null)) {
                throw new global::System.ArgumentNullException("CustomerName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerName, string Address, string Phone, int Original_CustomerId, string Original_CustomerName, string Original_Address, string Original_Phone) {
            return this.Update(CustomerName, Address, Phone, Original_CustomerId, Original_CustomerName, Original_Address, Original_Phone, Original_CustomerId);
        }
    }
